  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(400px circle at ${spot.x}% ${spot.y}%, hsl(var(--brand-primary) / 0.22), transparent 60%)`,
        }}
      />
      {/* faint grid */}
      <div
        ...
        <div className="relative p-4 xl:p-5 2xl:p-6">
          <div className="mb-3 flex items-end justify-between">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button className="inline-flex items-center gap-1.5 rounded-md bg-brand-primary px-2.5 py-1 text-[11px] font-semibold text-brand-black shadow-[0_6px_20px_-6px_hsl(var(--brand-primary)_/_0.6)] transition hover:brightness-110">
...
function MobileDashboard() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-[320px]">
      ...
      {/* ambient glow */}
      <div className="pointer-events-none absolute -inset-6 -z-10 rounded-[3rem] bg-[radial-gradient(ellipse_at_center,hsl(var(--brand-primary)_/_0.18),transparent_70%)] blur-2xl" />
    </div>
  )
}
  ...
  return (
    <section className="px-3 pb-6 lg:px-4 lg:pb-8">
      <div className="relative overflow-hidden rounded-2xl bg-brand-black px-6 py-16 md:px-10 md:py-20 lg:rounded-3xl lg:px-12 lg:py-24">
        ...
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,hsl(var(--brand-primary)_/_0.18),transparent)]" />
