...
function WelcomeBackCopy({ className }: { className?: string }) {
  return (
    <div className={cn(className)}>
      <h1 className="font-special-gothic text-5xl leading-[0.9] tracking-tight text-balance text-brand-black sm:text-6xl xl:text-7xl">
        Welcome
        <br />
        back.
      </h1>
      <p className="mt-4 max-w-xl text-base leading-relaxed text-brand-black/70 sm:mt-5 xl:mt-6 xl:text-lg">
        Manage entries, review submissions, and run your photo marathon from one place. Sign in to
