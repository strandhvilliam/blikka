          ...
          <Link href={homeHref} className="flex items-center gap-3">
            {marathon.logoUrl ? (
              ...
              <img
                ...
                className="size-11 rounded-md object-cover ring-1 ring-white/10"
              />
            ) : null}
            <div className="flex flex-col">
              ...
              <h1 className="font-special-gothic text-xl leading-tight tracking-tight text-white sm:text-2xl">
                {marathon.name}
              </h1>
            </div>
          </Link>
