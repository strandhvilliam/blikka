...
export function TopicsMarathonEmptyState({ onCreateClick }: TopicsMarathonEmptyStateProps) {
  return (
    <div className="flex min-w-0 w-full flex-col items-stretch justify-center rounded-xl border border-dashed border-border bg-muted/30 px-4 py-10 text-center sm:px-6 sm:py-14">
      ...
      <p className="mt-2 min-w-0 max-w-lg text-balance text-sm leading-relaxed text-muted-foreground mx-auto">
        Add your first topic to start building the marathon sequence. You can drag topics to change
        their order anytime.
      </p>
