...
export function DateDurationSummary({ startDate, endDate }: DateDurationSummaryProps) {
  return (
    <div className="mt-4 p-4 bg-muted/30 rounded-lg border border-muted flex flex-col gap-2">
      <div className="flex items-center gap-2">
        ...
        {startDate && endDate ? (
          ...
          <span className="text-sm text-muted-foreground">Select both dates to see duration</span>
        )}
      </div>
      {startDate && endDate && (
