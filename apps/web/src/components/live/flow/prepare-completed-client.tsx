...
import { ArrowRight, CheckCircle2, Hash, Mail, ShieldCheck, Users } from 'lucide-react'
    ...
    <div className="min-h-dvh px-4 py-6 sm:px-6 sm:py-10 max-w-md mx-auto flex flex-col">
      ...
      >
        ...
        >
          ...
          <h1 className="text-3xl font-rocgrotesk font-bold text-foreground">{t('title')}</h1>
        ...
        <Card className="bg-green-50/60 border-green-200 dark:bg-green-950/20 dark:border-green-800 overflow-hidden">
          <CardContent className="p-4 space-y-4">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">{t('participantNumberHelp')}</p>
            </div>
