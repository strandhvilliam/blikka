...
import { Info, Star, ArrowLeftRight, SlidersHorizontal, Heart, CheckCircle2 } from 'lucide-react'
    ...
    <Drawer>
      ...
      <DrawerContent className="max-h-[85vh]">
        ...
        <div className="max-h-[calc(85vh-80px)] space-y-3 overflow-y-auto px-4 py-4">
          {steps.map((step) => (
            <div key={step.titleKey} className="rounded-2xl border border-border bg-white p-4">
