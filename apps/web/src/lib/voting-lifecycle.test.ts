...
describe('web voting lifecycle helpers', () => {
  ...
  it('treats missing or future scheduledStart as not-started', () => {
    ...
    expect(getSubmissionLifecycleState('2026-03-17T12:00:00.000Z', null, now)).toBe('not-started')
  })

  it('tracks whether the submission window is open or ended', () => {
    expect(getSubmissionLifecycleState('2026-03-17T08:00:00.000Z', null, now)).toBe('open')
    expect(
