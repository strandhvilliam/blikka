...
import { getUploadErrorPresentation, getUploadSummaryPresentation } from './upload-error-presenter'
import type { UploadFileState } from './types'
import { UPLOAD_PHASE } from './types'

function createError(overrides: Partial<ClientUploadError> = {}): ClientUploadError {
  return {
