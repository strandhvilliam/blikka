...
interface CookieConsentProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  /** Override card background and styling (e.g. "bg-slate-900 text-white") */
  cardClassName?: string
  /** Override Accept button styling (e.g. "bg-emerald-600 hover:bg-emerald-700") */
  acceptButtonClassName?: string
  /** Override Decline button styling (e.g. "bg-slate-700 hover:bg-slate-600") */
