  ...
  return (
    <section className="space-y-2">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-semibold font-rocgrotesk">Competition Classes</h2>
      </div>
      <p className="text-sm text-muted-foreground pb-4">
        Here you can add, edit, or remove competition classes for the marathon. Each class
        determines how many photos participants need to take and what topics they will start from.
        Use this section to organize the different groups or categories for your event.
      </p>
