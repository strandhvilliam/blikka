...
export type CreateCompetitionClassInput = Schema.Schema.Type<typeof CreateCompetitionClassInputSchema>
export type UpdateCompetitionClassInput = Schema.Schema.Type<typeof UpdateCompetitionClassInputSchema>
export type DeleteCompetitionClassInput = Schema.Schema.Type<typeof DeleteCompetitionClassInputSchema>
