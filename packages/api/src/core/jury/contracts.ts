...
export type GetJuryInvitationsByDomainInput = Schema.Schema.Type<typeof GetJuryInvitationsByDomainInputSchema>
export type GetJuryInvitationByIdInput = Schema.Schema.Type<typeof GetJuryInvitationByIdInputSchema>
export type GetJuryReviewResultsByInvitationIdInput = Schema.Schema.Type<typeof GetJuryReviewResultsByInvitationIdInputSchema>
...
export type GetJurySubmissionsFromToken = Schema.Schema.Type<typeof GetJurySubmissionsFromTokenSchema>
