...
>;
export type GetLogoUploadUrlInput = Schema.Schema.Type<
  typeof GetLogoUploadUrlInputSchema
>;
export type GetTermsUploadUrlInput = Schema.Schema.Type<
  typeof GetTermsUploadUrlInputSchema
>;
export type GetCurrentTermsInput = Schema.Schema.Type<
  typeof GetCurrentTermsInputSchema
>;
