...
export type GetParticipantsExportDataInput = Schema.Schema.Type<
  typeof GetParticipantsExportDataInputSchema
>
export type GetSubmissionsExportDataInput = Schema.Schema.Type<
  typeof GetSubmissionsExportDataInputSchema
>
export type GetValidationResultsExportDataInput = Schema.Schema.Type<
  typeof GetValidationResultsExportDataInputSchema
>
