...
export const GetTopicsWithSubmissionCountInputSchema = Schema.Struct({
  domain: Schema.String,
})
...
export type GetTopicsWithSubmissionCountInput = Schema.Schema.Type<
  typeof GetTopicsWithSubmissionCountInputSchema
>
