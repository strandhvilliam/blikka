...
export class ZipFilesService extends Context.Service<ZipFilesService>()(
  "@blikka/api/ZipFilesService",
  {
    make: Effect.gen(function* () {
      ...
      const getZipSubmissionStats = Effect.fn("ZipFilesService.getZipSubmissionStats")(
      ...
      const getZipDownloadProgress = Effect.fn("ZipFilesService.getZipDownloadProgress")(
      ...
      const getActiveProcess = Effect.fn("ZipFilesService.getActiveProcess")(function* ({
        domain,
      }: {
        domain: string
      }) {
      ...
      const cancelDownloadProcess = Effect.fn("ZipFilesService.cancelDownloadProcess")(
      ...
      const getZipDownloadUrls = Effect.fn("ZipFilesService.getZipDownloadUrls")(function* ({
        processId,
      }: {
        processId: string
      }) {
      ...
      const initializeZipDownloads = Effect.fn("ZipFilesService.initializeZipDownloads")(
        function* ({ domain }: { domain: string }) {
          try {
