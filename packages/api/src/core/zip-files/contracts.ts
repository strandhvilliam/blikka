...
export type InitializeZipDownloadsInput = Schema.Schema.Type<typeof InitializeZipDownloadsInputSchema>
export type GetZipSubmissionStatusInput = Schema.Schema.Type<typeof GetZipSubmissionStatusInputSchema>
export type GetZipSubmissionStatusOutput = Schema.Schema.Type<typeof GetZipSubmissionStatusOutputSchema>
export type GetZipDownloadProgressInput = Schema.Schema.Type<typeof GetZipDownloadProgressInputSchema>
