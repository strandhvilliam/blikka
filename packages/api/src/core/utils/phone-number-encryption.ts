...
export class PhoneNumberEncryptionService extends Context.Service<
  PhoneNumberEncryptionService,
  {
    ...
    readonly encrypt: (params: {
      phoneNumber: string
    }) => Effect.Effect<
      { encrypted: EncryptedPhoneNumber; hash: PhoneHash },
      PhoneNumberEncryptionError
    >
    /** Decrypt an encrypted phone number. */
    readonly decrypt: (params: {
      encrypted: EncryptedPhoneNumber
    }) => Effect.Effect<string, PhoneNumberEncryptionError>
    /** Lookup a phone hash. */
    readonly hashLookup: (params: {
      phoneNumber: string
...
export const PhoneNumberEncryptionServiceLayer = Layer.effect(
  PhoneNumberEncryptionService,
  makePhoneNumberEncryptionService,
)
