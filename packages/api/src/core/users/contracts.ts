...
export type GetStaffMembersByDomainInput = Schema.Schema.Type<
  typeof GetStaffMembersByDomainInputSchema
>
...
export type DeleteUserMarathonRelationInput = Schema.Schema.Type<
  typeof DeleteUserMarathonRelationInputSchema
>
export type GetVerificationsByStaffIdInput = Schema.Schema.Type<
  typeof GetVerificationsByStaffIdInputSchema
>
