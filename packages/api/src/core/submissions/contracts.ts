...
export type BeginAdminReplaceUploadInput = Schema.Schema.Type<
  typeof BeginAdminReplaceUploadInputSchema
>
export type CompleteAdminReplaceUploadInput = Schema.Schema.Type<
  typeof CompleteAdminReplaceUploadInputSchema
>
export type RegenerateSubmissionAssetsInput = Schema.Schema.Type<
  typeof RegenerateSubmissionAssetsInputSchema
>
