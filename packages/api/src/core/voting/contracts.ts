...
export type StartVotingSessionsForParticipants = Schema.Schema.Type<typeof StartVotingSessionsForParticipantsSchema>
...
export type ResendVotingSessionNotification = Schema.Schema.Type<typeof ResendVotingSessionNotificationSchema>
