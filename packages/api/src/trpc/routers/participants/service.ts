...
export class ParticipantsApiService extends Context.Service<ParticipantsApiService>()(
  "@blikka/api/ParticipantsApiService",
  {
    make: Effect.gen(function* () {
      ...
      const getDashboardOverview = Effect.fn("ParticipantsApiService.getDashboardOverview")(
      ...
      const batchDelete = Effect.fn("ParticipantsApiService.batchDelete")(function* ({
        ids,
        domain,
      }: {
        ids: readonly number[]
      ...
      const batchVerify = Effect.fn("ParticipantsApiService.batchVerify")(function* ({
        ids,
        domain,
      }: {
        ids: readonly number[]
      ...
      const batchMarkCompleted = Effect.fn("ParticipantsApiService.batchMarkCompleted")(function* ({
        ids,
        domain,
      }: {
        ids: readonly number[]
      ...
      const verifyParticipant = Effect.fn("ParticipantsApiService.verifyParticipant")(function* ({
        id,
        domain,
      }: {
        id: number
