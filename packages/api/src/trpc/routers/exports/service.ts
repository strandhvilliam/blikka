...
export class ExportsApiService extends Context.Service<ExportsApiService>()(
  "@blikka/api/ExportsApiService",
  {
    make: Effect.gen(function* () {
      ...
      const getActiveByCameraTopic = Effect.fn("ExportsApiService.getActiveByCameraTopic")(
      ...
      const buildArchiveBuffer = Effect.fn("ExportsApiService.buildArchiveBuffer")(function* (
        files: ReadonlyArray<{
          data: Buffer
          name: string
        }>,
  ...
  static readonly layer = Layer.effect(this, this.make).pipe(
    Layer.provide(Layer.mergeAll(DbLayer, S3ServiceLayer, PhoneNumberEncryptionService.layer)),
  )
}
