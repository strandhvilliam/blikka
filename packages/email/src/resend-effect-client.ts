...
export class ResendEffectClient extends Context.Service<
  ResendEffectClient,
  {
    readonly use: <T>(
      fn: (client: Resend) => T,
    ) => Effect.Effect<Awaited<T>, ResendEffectError>
  }
          ...
          new ResendEffectError({
            ...
            message:
              error instanceof Error
                ? error.message
                : "Unknown error in ResendEffectClient.use",
          }),
      })
          ...
          try: () => result,
            ...
            new ResendEffectError({
              ...
              message:
                e instanceof Error
                  ? e.message
                  : "Unknown error in ResendEffectClient.use (Async)",
            }),
        })
      }
      return result
...
export const ResendEffectClientLayer = Layer.effect(
  ResendEffectClient,
  makeResendEffectClient,
)
