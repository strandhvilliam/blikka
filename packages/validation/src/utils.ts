...
export const getTimestamp = (exif: Record<string, unknown>): Option.Option<Date> =>
  Option.fromNullishOr(exif.DateTimeOriginal ?? exif.DateTimeDigitized ?? exif.CreateDate).pipe(
...
export const getDeviceIdentifier = (exif: Record<string, unknown>): Option.Option<string> =>
...
export const getExtensionFromFilename = (filename: string): Option.Option<string> => {
