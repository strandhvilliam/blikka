...
export class MarathonsRepository extends Context.Service<
  ...
  readonly getMarathons: () => Effect.Effect<
    MarathonWithTopicsAndCompetitionClasses[],
    DbError
  >;
  ...
  readonly createMarathon: (params: {
    data: NewMarathon;
  ...
  readonly deleteMarathon: (params: {
    id: number;
  }) => Effect.Effect<Marathon, DbError>;
  /**
...
const makeMarathonsRepository = Effect.gen(function* () {
  ...
  const getMarathons: MarathonsRepository["Service"]["getMarathons"] =
    Effect.fn("MarathonsRepository.getMarathons")(function* () {
      return yield* use((db) =>
  ...
  const getMarathonById: MarathonsRepository["Service"]["getMarathonById"] =
    Effect.fn("MarathonsRepository.getMarathonById")(function* ({ id }) {
  ...
  const getMarathonByDomain: MarathonsRepository["Service"]["getMarathonByDomain"] =
    Effect.fn("MarathonsRepository.getMarathonByDomain")(function* ({
      domain,
    }) {
      const result = yield* use((db) =>
        db.query.marathons.findFirst({
  ...
  const getMarathonByDomainWithOptions: MarathonsRepository["Service"]["getMarathonByDomainWithOptions"] =
    Effect.fn("MarathonsRepository.getMarathonByDomainWithOptions")(function* ({
      domain,
    }) {
      const result = yield* use((db) =>
        db.query.marathons.findFirst({
  ...
  const createMarathon: MarathonsRepository["Service"]["createMarathon"] =
    Effect.fn("MarathonsRepository.createMarathon")(function* ({ data }) {
      const [result] = yield* use((db) =>
  ...
  const updateMarathon: MarathonsRepository["Service"]["updateMarathon"] =
    Effect.fn("MarathonsRepository.updateMarathon")(function* ({ id, data }) {
      const [result] = yield* use((db) =>
  ...
  const updateMarathonByDomain: MarathonsRepository["Service"]["updateMarathonByDomain"] =
    Effect.fn("MarathonsRepository.updateMarathonByDomain")(function* ({
      domain,
      data,
    }) {
      if (!data.updatedAt) {
  ...
  const deleteMarathon: MarathonsRepository["Service"]["deleteMarathon"] =
    Effect.fn("MarathonsRepository.deleteMarathon")(function* ({ id }) {
      const [result] = yield* use((db) =>
  ...
  const resetMarathon: MarathonsRepository["Service"]["resetMarathon"] =
    Effect.fn("MarathonsRepository.resetMarathon")(function* ({ id }) {
  ...
  const clearOperationalSeedableData: MarathonsRepository["Service"]["clearOperationalSeedableData"] =
    Effect.fn("MarathonsRepository.clearOperationalSeedableData")(function* ({
      id,
    }) {
      const marathon = yield* use((db) =>
        db.query.marathons.findFirst({
