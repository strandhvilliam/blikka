...
const makeSponsorsRepository = Effect.gen(function* () {
  ...
  const getSponsorsByMarathonId: SponsorsRepository["Service"]["getSponsorsByMarathonId"] =
    Effect.fn("SponsorsRepository.getSponsorsByMarathonId")(function* ({
      marathonId,
    }) {
  ...
  const getLatestSponsorByType: SponsorsRepository["Service"]["getLatestSponsorByType"] =
    Effect.fn("SponsorsRepository.getLatestSponsorByType")(function* ({
      marathonId,
      type,
    }) {
      const result = yield* use((db) =>
  ...
  const getSponsorsByType: SponsorsRepository["Service"]["getSponsorsByType"] =
    Effect.fn("SponsorsRepository.getSponsorsByType")(function* ({
      marathonId,
      type,
    }) {
      const result = yield* use((db) =>
  ...
  const getSponsorById: SponsorsRepository["Service"]["getSponsorById"] =
    Effect.fn("SponsorsRepository.getSponsorById")(function* ({ id }) {
      const result = yield* use((db) =>
        db.query.sponsors.findFirst({
  ...
  const createSponsor: SponsorsRepository["Service"]["createSponsor"] =
    Effect.fn("SponsorsRepository.createSponsor")(function* ({ data }) {
      const [result] = yield* use((db) =>
        db
          .insert(sponsors)
          .values({
  ...
  const updateSponsor: SponsorsRepository["Service"]["updateSponsor"] =
    Effect.fn("SponsorsRepository.updateSponsor")(function* ({ id, data }) {
      const updateData = {
        ...data,
  ...
  const deleteSponsor: SponsorsRepository["Service"]["deleteSponsor"] =
    Effect.fn("SponsorsRepository.deleteSponsor")(function* ({ id }) {
      const [result] = yield* use((db) =>
        db
          .delete(sponsors)
          .where(eq(sponsors.id, id))
